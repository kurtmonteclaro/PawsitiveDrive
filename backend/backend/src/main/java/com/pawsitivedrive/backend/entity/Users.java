...
public class Users {
    ...
    // Optional: Constructor for easy creation in AuthController
    public Users(String name, String email, String password, Roles role, String status) {
        this.name = name;
        this.email = email;
    ...
    // ... (Your existing getters and setters are correctly placed here) ...
